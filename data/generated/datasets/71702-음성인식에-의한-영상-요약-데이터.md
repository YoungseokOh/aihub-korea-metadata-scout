...
## Basic Info
- Dataset Key: `71702`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 71702`
- Collected At: `2026-03-17T08:41:33.199495+00:00`
...
## File Overview
- File count: `53`
- Total known size: `2.26 TB`
- Representative file paths:
  - `018.음성인식에 의한 영상 요약 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_교양_1.zip`
  - `018.음성인식에 의한 영상 요약 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_교양_2.zip`
  - `018.음성인식에 의한 영상 요약 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_교양_3.zip`
  - `018.음성인식에 의한 영상 요약 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_교양_4.zip`
  - `018.음성인식에 의한 영상 요약 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_뉴스_1.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `speech/dialogue` 성격의 `video` 자료로 보입니다. 확인 가능한 파일은 53개이며 알려진 총 용량은 2.26 TB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
...
```json
{
  ...
  "file_count": 53,
  "total_size_bytes": 2486903951360,
  "human_size": "2.26 TB",
  "sample_file_paths": [
    "018.음성인식에 의한 영상 요약 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_교양_1.zip",
    "018.음성인식에 의한 영상 요약 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_교양_2.zip",
