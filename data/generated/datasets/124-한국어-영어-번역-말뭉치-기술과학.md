...
## Basic Info
- Dataset Key: `124`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 124`
- Collected At: `2026-03-17T08:40:29.564006+00:00`
...
- Representative file paths:
  - `026.한국어-영어 번역 말뭉치 1/01.데이터/1.Training_1113_add/1113_tech_train_set_1195228.zip`
  - `026.한국어-영어 번역 말뭉치 1/01.데이터/2.Validation_1113_add/1113_tech_valid_set_149403.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `nlp/knowledge` 성격의 `text` 자료로 보입니다. 확인 가능한 파일은 2개이며 알려진 총 용량은 450.0 MB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
