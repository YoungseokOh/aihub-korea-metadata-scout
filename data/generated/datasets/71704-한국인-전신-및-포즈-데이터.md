...
## Basic Info
- Dataset Key: `71704`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 71704`
- Collected At: `2026-03-17T08:41:33.372216+00:00`
...
## File Overview
- File count: `43`
- Total known size: `3.69 TB`
- Representative file paths:
  - `030.한국인 전신 및 포즈 데이터/3.개방데이터/1.데이터/Other/Other.z01`
  - `030.한국인 전신 및 포즈 데이터/3.개방데이터/1.데이터/Other/Other.z02`
  - `030.한국인 전신 및 포즈 데이터/3.개방데이터/1.데이터/Other/Other.z03`
  - `030.한국인 전신 및 포즈 데이터/3.개방데이터/1.데이터/Other/Other.z04`
  - `030.한국인 전신 및 포즈 데이터/3.개방데이터/1.데이터/Other/Other.z05`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `범용 데이터` 성격의 `명확하지 않은 형태` 자료로 보입니다. 확인 가능한 파일은 43개이며 알려진 총 용량은 3.69 TB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
...
```json
{
  ...
  "modality_guess": null,
  "file_count": 43,
  "total_size_bytes": 4059908014080,
  "human_size": "3.69 TB",
  "sample_file_paths": [
    "030.한국인 전신 및 포즈 데이터/3.개방데이터/1.데이터/Other/Other.z01",
    "030.한국인 전신 및 포즈 데이터/3.개방데이터/1.데이터/Other/Other.z02",
