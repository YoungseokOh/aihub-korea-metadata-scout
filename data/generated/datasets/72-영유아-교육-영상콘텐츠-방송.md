...
## Basic Info
- Dataset Key: `72`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 72`
- Collected At: `2026-03-17T08:40:23.064688+00:00`
...
- Representative file paths:
  - `089.영유아 교육 영상콘텐츠 방송 데이터/01.데이터/01. Training/[라벨]trian.zip`
  - `089.영유아 교육 영상콘텐츠 방송 데이터/01.데이터/클립동영상/EBS/program-0001/video-0000~0039.zip`
  - `089.영유아 교육 영상콘텐츠 방송 데이터/01.데이터/클립동영상/EBS/program-0001/video-0040~0075.zip`
  - `089.영유아 교육 영상콘텐츠 방송 데이터/01.데이터/클립동영상/EBS/program-0002/video-0000~0003.zip`
  - `089.영유아 교육 영상콘텐츠 방송 데이터/01.데이터/클립동영상/EBS/program-0003/video-0000~0003.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `education` 성격의 `video` 자료로 보입니다. 확인 가능한 파일은 182개이며 알려진 총 용량은 3.29 TB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
...
```json
{
  ...
  "file_count": 182,
  "total_size_bytes": 3618624241664,
  "human_size": "3.29 TB",
  "sample_file_paths": [
    "089.영유아 교육 영상콘텐츠 방송 데이터/01.데이터/01. Training/[라벨]trian.zip",
    "089.영유아 교육 영상콘텐츠 방송 데이터/01.데이터/클립동영상/EBS/program-0001/video-0000~0039.zip",
