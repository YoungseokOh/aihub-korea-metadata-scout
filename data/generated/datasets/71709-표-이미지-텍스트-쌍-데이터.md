...
## Basic Info
- Dataset Key: `71709`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 71709`
- Collected At: `2026-03-17T08:41:33.770038+00:00`
...
## File Overview
- File count: `97`
- Total known size: `34.0 GB`
- Representative file paths:
  - `032.표 이미지-텍스트 쌍 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_T01_C01.zip`
  - `032.표 이미지-텍스트 쌍 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_T01_C02.zip`
  - `032.표 이미지-텍스트 쌍 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_T01_C03.zip`
  - `032.표 이미지-텍스트 쌍 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_T01_C04.zip`
  - `032.표 이미지-텍스트 쌍 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_T01_C05.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `computer-vision` 성격의 `text` 자료로 보입니다. 확인 가능한 파일은 97개이며 알려진 총 용량은 34.0 GB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
