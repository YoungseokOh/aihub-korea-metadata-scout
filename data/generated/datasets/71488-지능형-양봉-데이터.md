...
## Basic Info
- Dataset Key: `71488`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 71488`
- Collected At: `2026-03-17T08:41:16.733818+00:00`
...
- Representative file paths:
  - `106.지능형 양봉 데이터/01-1.정식개방데이터/Other/음성 데이터_분봉_집단이동징후_01_1_SW_20221116.zip`
  - `106.지능형 양봉 데이터/01-1.정식개방데이터/Other/음성 데이터_분봉_집단이동징후_01_1_SW_20221117.zip`
  - `106.지능형 양봉 데이터/01-1.정식개방데이터/Other/음성 데이터_분봉_집단이동징후_01_1_SW_20221118.zip`
  - `106.지능형 양봉 데이터/01-1.정식개방데이터/Other/음성 데이터_분봉_집단이동징후_01_1_SW_20221121.zip`
  - `106.지능형 양봉 데이터/01-1.정식개방데이터/Other/환경 데이터_01_곤충잡업연구소(장성).zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `speech/dialogue` 성격의 `audio` 자료로 보입니다. 확인 가능한 파일은 156개이며 알려진 총 용량은 76.8 GB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
