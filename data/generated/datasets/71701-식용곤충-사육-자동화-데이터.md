...
## Basic Info
- Dataset Key: `71701`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 71701`
- Collected At: `2026-03-17T08:41:33.130168+00:00`
...
## File Overview
- File count: `146`
- Total known size: `152.5 GB`
- Representative file paths:
  - `064.식용곤충 사육 자동화 데이터/3.개방데이터/1.데이터/Other/Other.zip`
  - `064.식용곤충 사육 자동화 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_R_BOX_AB_NM.zip`
  - `064.식용곤충 사육 자동화 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_R_BOX_AB_UN.zip`
  - `064.식용곤충 사육 자동화 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_R_BOX_GR_NM.zip`
  - `064.식용곤충 사육 자동화 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_R_BOX_GR_UN.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `범용 데이터` 성격의 `명확하지 않은 형태` 자료로 보입니다. 확인 가능한 파일은 146개이며 알려진 총 용량은 152.5 GB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
