...
## Basic Info
- Dataset Key: `193`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 193`
- Collected At: `2026-03-17T08:40:37.526135+00:00`
...
## File Overview
- File count: `226`
- Total known size: `2.32 TB`
- Representative file paths:
  - `057.주차장애물 인지 영상/01.데이터/2.Validation/1.라벨링데이터/바운딩박스/경기도/경기도_FLRR_5_01.zip`
  - `057.주차장애물 인지 영상/01.데이터/2.Validation/1.라벨링데이터/바운딩박스/경기도/경기도_FLRR_5_02.zip`
  - `057.주차장애물 인지 영상/01.데이터/2.Validation/1.라벨링데이터/바운딩박스/경상남도/경상남도_FLRR_5_01.zip`
  - `057.주차장애물 인지 영상/01.데이터/2.Validation/1.라벨링데이터/바운딩박스/경상남도/경상남도_FLRR_5_02.zip`
  - `057.주차장애물 인지 영상/01.데이터/2.Validation/1.라벨링데이터/바운딩박스/경상북도/경상북도_AVM_5_01.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `computer-vision` 성격의 `video` 자료로 보입니다. 확인 가능한 파일은 226개이며 알려진 총 용량은 2.32 TB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
...
```json
{
  ...
  "file_count": 226,
  "total_size_bytes": 2554597366784,
  "human_size": "2.32 TB",
  "sample_file_paths": [
    "057.주차장애물 인지 영상/01.데이터/2.Validation/1.라벨링데이터/바운딩박스/경기도/경기도_FLRR_5_01.zip",
    "057.주차장애물 인지 영상/01.데이터/2.Validation/1.라벨링데이터/바운딩박스/경기도/경기도_FLRR_5_02.zip",
