...
## Basic Info
- Dataset Key: `71829`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 71829`
- Collected At: `2026-03-17T08:41:42.871488+00:00`
...
## File Overview
- File count: `93`
- Total known size: `188.8 GB`
- Representative file paths:
  - `62.In-door 육묘장 생장 데이터/3.개방데이터/1.데이터/Other/Other.zip`
  - `62.In-door 육묘장 생장 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_1.고추_2.떡잎.zip`
  - `62.In-door 육묘장 생장 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_1.고추_3.본엽2매.zip`
  - `62.In-door 육묘장 생장 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_1.고추_4.본엽4매~8매.zip`
  - `62.In-door 육묘장 생장 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_1.고추_5.본엽8매~10매.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `범용 데이터` 성격의 `명확하지 않은 형태` 자료로 보입니다. 확인 가능한 파일은 93개이며 알려진 총 용량은 188.8 GB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
