...
## Basic Info
- Dataset Key: `77`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 77`
- Collected At: `2026-03-17T08:40:23.675980+00:00`
...
## File Overview
- File count: `348`
- Total known size: `7.17 TB`
- Representative file paths:
  - `147.초해상화 이미지/01.데이터/1.Training/2.원천데이터/HR/1.농업, 임업 및 어업 생산물/1.농업, 원예, 어류 생산물_14.zip`
  - `147.초해상화 이미지/01.데이터/1.Training/2.원천데이터/HR/1.농업, 임업 및 어업 생산물/1.농업, 원예, 어류 생산물_15.zip`
  - `147.초해상화 이미지/01.데이터/1.Training/2.원천데이터/HR/1.농업, 임업 및 어업 생산물/1.농업, 원예, 어류 생산물_16.zip`
  - `147.초해상화 이미지/01.데이터/1.Training/2.원천데이터/HR/1.농업, 임업 및 어업 생산물/1.농업, 원예, 어류 생산물_17.zip`
  - `147.초해상화 이미지/01.데이터/1.Training/2.원천데이터/HR/1.농업, 임업 및 어업 생산물/1.농업, 원예, 어류 생산물_18.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `computer-vision` 성격의 `image` 자료로 보입니다. 확인 가능한 파일은 348개이며 알려진 총 용량은 7.17 TB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
...
{
  "dataset_key": 77,
  "title": "초해상화(Super Resolution) 이미지",
  "tags": [
    "computer-vision",
    "image",
    "이미지",
  ...
  "file_count": 348,
  "total_size_bytes": 7879604043776,
  "human_size": "7.17 TB",
  "sample_file_paths": [
    "147.초해상화 이미지/01.데이터/1.Training/2.원천데이터/HR/1.농업, 임업 및 어업 생산물/1.농업, 원예, 어류 생산물_14.zip",
    "147.초해상화 이미지/01.데이터/1.Training/2.원천데이터/HR/1.농업, 임업 및 어업 생산물/1.농업, 원예, 어류 생산물_15.zip",
