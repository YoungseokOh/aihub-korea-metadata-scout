...
## Basic Info
- Dataset Key: `89`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 89`
- Collected At: `2026-03-17T08:40:25.842555+00:00`
...
## File Overview
- File count: `3`
- Total known size: `84.0 MB`
- Representative file paths:
  - `11.기계독해/01.Normal.zip`
  - `11.기계독해/02.NoAnswer.zip`
  - `11.기계독해/03.Clue_.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `범용 데이터` 성격의 `명확하지 않은 형태` 자료로 보입니다. 확인 가능한 파일은 3개이며 알려진 총 용량은 84.0 MB입니다. 파일 트리 정보가 제한적이어서 구조 판단은 보수적으로 해석해야 합니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
