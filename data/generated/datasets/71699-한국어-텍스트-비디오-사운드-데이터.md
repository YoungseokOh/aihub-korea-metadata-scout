...
## Basic Info
- Dataset Key: `71699`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 71699`
- Collected At: `2026-03-17T08:41:32.985355+00:00`
...
## File Overview
- File count: `136`
- Total known size: `3.29 TB`
- Representative file paths:
  - `017.한국어 텍스트-비디오-사운드 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_01. 스포츠_1.zip`
  - `017.한국어 텍스트-비디오-사운드 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_01. 스포츠_2.zip`
  - `017.한국어 텍스트-비디오-사운드 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_02. 게임_1.zip`
  - `017.한국어 텍스트-비디오-사운드 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_02. 게임_2.zip`
  - `017.한국어 텍스트-비디오-사운드 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_03. 음악.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `education` 성격의 `video` 자료로 보입니다. 확인 가능한 파일은 136개이며 알려진 총 용량은 3.29 TB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
...
```json
{
  ...
  "file_count": 136,
  "total_size_bytes": 3613587493888,
  "human_size": "3.29 TB",
  "sample_file_paths": [
    "017.한국어 텍스트-비디오-사운드 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_01. 스포츠_1.zip",
    "017.한국어 텍스트-비디오-사운드 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_01. 스포츠_2.zip",
