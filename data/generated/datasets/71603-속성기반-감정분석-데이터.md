...
## Basic Info
- Dataset Key: `71603`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 71603`
- Collected At: `2026-03-17T08:41:27.691196+00:00`
...
## File Overview
- File count: `100`
- Total known size: `58.6 MB`
- Representative file paths:
  - `147.속성기반 감정분석 데이터/01-1.정식개방데이터/Training/01.원천데이터/TS_SNS_01.패션.zip`
  - `147.속성기반 감정분석 데이터/01-1.정식개방데이터/Training/01.원천데이터/TS_SNS_02.화장품.zip`
  - `147.속성기반 감정분석 데이터/01-1.정식개방데이터/Training/01.원천데이터/TS_SNS_03.가전.zip`
  - `147.속성기반 감정분석 데이터/01-1.정식개방데이터/Training/01.원천데이터/TS_SNS_04.IT기기.zip`
  - `147.속성기반 감정분석 데이터/01-1.정식개방데이터/Training/01.원천데이터/TS_SNS_05.생활.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `computer-vision` 성격의 `video` 자료로 보입니다. 확인 가능한 파일은 100개이며 알려진 총 용량은 58.6 MB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
