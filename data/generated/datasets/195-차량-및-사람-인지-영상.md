...
## Basic Info
- Dataset Key: `195`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 195`
- Collected At: `2026-03-17T08:40:37.755536+00:00`
...
## File Overview
- File count: `219`
- Total known size: `2.11 TB`
- Representative file paths:
  - `059.차량 및 사람 인지 영상/01.데이터/1.Training/1.라벨링데이터_0831_ADD/바운딩박스/경기도/경기도_FLRR_2_11.zip`
  - `059.차량 및 사람 인지 영상/01.데이터/1.Training/1.라벨링데이터_0831_ADD/바운딩박스/경기도/경기도_FLRR_2_12.zip`
  - `059.차량 및 사람 인지 영상/01.데이터/1.Training/1.라벨링데이터_0831_ADD/바운딩박스/경기도/경기도_FLRR_2_14.zip`
  - `059.차량 및 사람 인지 영상/01.데이터/1.Training/1.라벨링데이터_0831_ADD/바운딩박스/경기도/경기도_FLRR_2_15.zip`
  - `059.차량 및 사람 인지 영상/01.데이터/1.Training/1.라벨링데이터_0831_ADD/바운딩박스/경기도/경기도_FLRR_2_16.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `computer-vision` 성격의 `video` 자료로 보입니다. 확인 가능한 파일은 219개이며 알려진 총 용량은 2.11 TB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
...
```json
{
  ...
  "file_count": 219,
  "total_size_bytes": 2317951328256,
  "human_size": "2.11 TB",
  "sample_file_paths": [
    "059.차량 및 사람 인지 영상/01.데이터/1.Training/1.라벨링데이터_0831_ADD/바운딩박스/경기도/경기도_FLRR_2_11.zip",
    "059.차량 및 사람 인지 영상/01.데이터/1.Training/1.라벨링데이터_0831_ADD/바운딩박스/경기도/경기도_FLRR_2_12.zip",
