...
## Basic Info
- Dataset Key: `189`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 189`
- Collected At: `2026-03-17T08:40:36.479457+00:00`
...
## File Overview
- File count: `54`
- Total known size: `608.0 GB`
- Representative file paths:
  - `15.인도보행영상/뎁스프리딕션/Depth_001~005.zip`
  - `15.인도보행영상/뎁스프리딕션/Depth_006~010.zip`
  - `15.인도보행영상/뎁스프리딕션/Depth_011~015.zip`
  - `15.인도보행영상/뎁스프리딕션/Depth_016~020.zip`
  - `15.인도보행영상/뎁스프리딕션/Depth_021~024.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `computer-vision` 성격의 `video` 자료로 보입니다. 확인 가능한 파일은 54개이며 알려진 총 용량은 608.0 GB입니다. 압축 파일 조각이 많아 보여 파일 정리와 전처리 부담이 커질 수 있습니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
