...
## Basic Info
- Dataset Key: `71379`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 71379`
- Collected At: `2026-03-17T08:41:07.200277+00:00`
...
## File Overview
- File count: `168`
- Total known size: `352.5 GB`
- Representative file paths:
  - `031.방송콘텐츠 한국어-영어 통·번역 음성 데이터/01-1.정식개방데이터/Training/01.원천데이터/TS_한-러_한국어음성_교양.zip`
  - `031.방송콘텐츠 한국어-영어 통·번역 음성 데이터/01-1.정식개방데이터/Training/01.원천데이터/TS_한-러_한국어음성_다큐.zip`
  - `031.방송콘텐츠 한국어-영어 통·번역 음성 데이터/01-1.정식개방데이터/Training/01.원천데이터/TS_한-러_한국어음성_연예공연.zip`
  - `031.방송콘텐츠 한국어-영어 통·번역 음성 데이터/01-1.정식개방데이터/Training/01.원천데이터/TS_한-러_한국어음성_영화드라마.zip`
  - `031.방송콘텐츠 한국어-영어 통·번역 음성 데이터/01-1.정식개방데이터/Training/01.원천데이터/TS_한-러_한국어음성_예능오락.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `speech/dialogue` 성격의 `video` 자료로 보입니다. 확인 가능한 파일은 168개이며 알려진 총 용량은 352.5 GB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
