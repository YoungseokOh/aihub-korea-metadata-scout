...
## Basic Info
- Dataset Key: `233`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 233`
- Collected At: `2026-03-17T08:40:38.963803+00:00`
...
## File Overview
- File count: `122`
- Total known size: `805.1 GB`
- Representative file paths:
  - `17.엑스레이위해물품/Images/Rapiscan/Knife.zip`
  - `17.엑스레이위해물품/Images/Rapiscan/LapTop.zip`
  - `17.엑스레이위해물품/Images/Rapiscan/Lighter.zip`
  - `17.엑스레이위해물품/Images/Rapiscan/Liquid.zip`
  - `17.엑스레이위해물품/Images/Rapiscan/Match.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `computer-vision` 성격의 `image` 자료로 보입니다. 확인 가능한 파일은 122개이며 알려진 총 용량은 805.1 GB입니다. 압축 파일 조각이 많아 보여 파일 정리와 전처리 부담이 커질 수 있습니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
