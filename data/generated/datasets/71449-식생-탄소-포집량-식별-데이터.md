...
## Basic Info
- Dataset Key: `71449`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 71449`
- Collected At: `2026-03-17T08:41:12.648536+00:00`
...
## File Overview
- File count: `88`
- Total known size: `52.0 GB`
- Representative file paths:
  - `120.식생 탄소 포집량 식별 데이터/01-1.정식개방데이터/Other/01.메타데이터_01.산림_AP_10.zip`
  - `120.식생 탄소 포집량 식별 데이터/01-1.정식개방데이터/Other/01.메타데이터_01.산림_AP_10_WIN.zip`
  - `120.식생 탄소 포집량 식별 데이터/01-1.정식개방데이터/Other/01.메타데이터_01.산림_AP_25.zip`
  - `120.식생 탄소 포집량 식별 데이터/01-1.정식개방데이터/Other/01.메타데이터_01.산림_NIR_10.zip`
  - `120.식생 탄소 포집량 식별 데이터/01-1.정식개방데이터/Other/01.메타데이터_01.산림_SN_10.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `computer-vision` 성격의 `image` 자료로 보입니다. 확인 가능한 파일은 88개이며 알려진 총 용량은 52.0 GB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
