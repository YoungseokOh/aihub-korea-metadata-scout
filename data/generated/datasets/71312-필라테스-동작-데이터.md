...
## Basic Info
- Dataset Key: `71312`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 71312`
- Collected At: `2026-03-17T08:41:00.441518+00:00`
...
## File Overview
- File count: `416`
- Total known size: `16.5 TB`
- Representative file paths:
  - `216.필라테스 동작 데이터/01-1.정식개방데이터/Training_1/Barrel/Barrel_train_1_1.zip`
  - `216.필라테스 동작 데이터/01-1.정식개방데이터/Training_1/Mat/Mat_train_1_1.zip`
  - `216.필라테스 동작 데이터/01-1.정식개방데이터/Training_1/Mat/Mat_train_1_10.zip`
  - `216.필라테스 동작 데이터/01-1.정식개방데이터/Training_1/Mat/Mat_train_1_11.zip`
  - `216.필라테스 동작 데이터/01-1.정식개방데이터/Training_1/Mat/Mat_train_1_12.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `범용 데이터` 성격의 `명확하지 않은 형태` 자료로 보입니다. 확인 가능한 파일은 416개이며 알려진 총 용량은 16.5 TB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
...
```json
{
  ...
  "modality_guess": null,
  "file_count": 416,
  "total_size_bytes": 18152679276544,
  "human_size": "16.5 TB",
  "sample_file_paths": [
    "216.필라테스 동작 데이터/01-1.정식개방데이터/Training_1/Barrel/Barrel_train_1_1.zip",
    "216.필라테스 동작 데이터/01-1.정식개방데이터/Training_1/Mat/Mat_train_1_1.zip",
