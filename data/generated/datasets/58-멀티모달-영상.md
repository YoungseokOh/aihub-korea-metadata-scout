...
## Basic Info
- Dataset Key: `58`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 58`
- Collected At: `2026-03-17T08:40:21.400660+00:00`
...
## File Overview
- File count: `14`
- Total known size: `89.0 GB`
- Representative file paths:
  - `18.멀티모달영상/0001-0400.zip`
  - `18.멀티모달영상/0401-0800.zip`
  - `18.멀티모달영상/0801-1200.zip`
  - `18.멀티모달영상/1201-1600.zip`
  - `18.멀티모달영상/1601-2000.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `computer-vision` 성격의 `multimodal` 자료로 보입니다. 확인 가능한 파일은 14개이며 알려진 총 용량은 89.0 GB입니다. 파일 트리 정보가 제한적이어서 구조 판단은 보수적으로 해석해야 합니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
