...
## Basic Info
- Dataset Key: `71594`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 71594`
- Collected At: `2026-03-17T08:41:26.878754+00:00`
...
## File Overview
- File count: `20`
- Total known size: `1.71 TB`
- Representative file paths:
  - `269.청청 서해안을 위한 유입 쓰레기 인공지능 데이터 구축/01-1.정식개방데이터/Training/01.원천데이터/TS.z01`
  - `269.청청 서해안을 위한 유입 쓰레기 인공지능 데이터 구축/01-1.정식개방데이터/Training/01.원천데이터/TS.z02`
  - `269.청청 서해안을 위한 유입 쓰레기 인공지능 데이터 구축/01-1.정식개방데이터/Training/01.원천데이터/TS.z03`
  - `269.청청 서해안을 위한 유입 쓰레기 인공지능 데이터 구축/01-1.정식개방데이터/Training/01.원천데이터/TS.z04`
  - `269.청청 서해안을 위한 유입 쓰레기 인공지능 데이터 구축/01-1.정식개방데이터/Training/01.원천데이터/TS.z05`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `범용 데이터` 성격의 `명확하지 않은 형태` 자료로 보입니다. 확인 가능한 파일은 20개이며 알려진 총 용량은 1.71 TB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
...
{
  "dataset_key": 71594,
  "title": "전북 새만금 방조제 유입 하천 쓰레기 데이터",
  "tags": [
    "방조제",
    "새만금",
    "쓰레기",
  ...
  "modality_guess": null,
  "file_count": 20,
  "total_size_bytes": 1875123372032,
  "human_size": "1.71 TB",
  "sample_file_paths": [
    "269.청청 서해안을 위한 유입 쓰레기 인공지능 데이터 구축/01-1.정식개방데이터/Training/01.원천데이터/TS.z01",
    "269.청청 서해안을 위한 유입 쓰레기 인공지능 데이터 구축/01-1.정식개방데이터/Training/01.원천데이터/TS.z02",
