...
## Basic Info
- Dataset Key: `71855`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 71855`
- Collected At: `2026-03-17T08:41:44.548047+00:00`
...
## File Overview
- File count: `402`
- Total known size: `129.7 GB`
- Representative file paths:
  - `28.교과단계별 교과 데이터/3.개방데이터/1.데이터/Other/Other_2.zip`
  - `28.교과단계별 교과 데이터/3.개방데이터/1.데이터/Other/Other_1.zip`
  - `28.교과단계별 교과 데이터/3.개방데이터/1.데이터/Validation/02.라벨링데이터/VL_06.중학교 1학년_07.기술가정_02.이미지.zip`
  - `28.교과단계별 교과 데이터/3.개방데이터/1.데이터/Validation/02.라벨링데이터/VL_07.중학교 2학년_01.국어_01.텍스트.zip`
  - `28.교과단계별 교과 데이터/3.개방데이터/1.데이터/Validation/02.라벨링데이터/VL_07.중학교 2학년_01.국어_02.이미지.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `education` 성격의 `text` 자료로 보입니다. 확인 가능한 파일은 402개이며 알려진 총 용량은 129.7 GB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
