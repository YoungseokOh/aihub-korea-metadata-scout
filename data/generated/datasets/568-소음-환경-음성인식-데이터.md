...
## Basic Info
- Dataset Key: `568`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 568`
- Collected At: `2026-03-17T08:40:48.822773+00:00`
...
## File Overview
- File count: `70`
- Total known size: `3.70 TB`
- Representative file paths:
  - `008.소음 환경 음성인식 데이터/01.데이터/1.Training/원천데이터_0824_add/TS6_11.복합소음_01.2가지이상소음원.zip`
  - `008.소음 환경 음성인식 데이터/01.데이터/1.Training/원천데이터_0824_add/TS1_01.가전소음_01.세탁기,건조기.zip`
  - `008.소음 환경 음성인식 데이터/01.데이터/1.Training/원천데이터_0824_add/TS1_01.가전소음_02.청소기.zip`
  - `008.소음 환경 음성인식 데이터/01.데이터/1.Training/원천데이터_0824_add/TS1_01.가전소음_03.가전소음_기타소음.zip`
  - `008.소음 환경 음성인식 데이터/01.데이터/1.Training/원천데이터_0824_add/TS1_02.교통수단_01.바이크.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `speech/dialogue` 성격의 `audio` 자료로 보입니다. 확인 가능한 파일은 70개이며 알려진 총 용량은 3.70 TB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
...
```json
{
  ...
  "file_count": 70,
  "total_size_bytes": 4066694397952,
  "human_size": "3.70 TB",
  "sample_file_paths": [
    "008.소음 환경 음성인식 데이터/01.데이터/1.Training/원천데이터_0824_add/TS6_11.복합소음_01.2가지이상소음원.zip",
    "008.소음 환경 음성인식 데이터/01.데이터/1.Training/원천데이터_0824_add/TS1_01.가전소음_01.세탁기,건조기.zip",
