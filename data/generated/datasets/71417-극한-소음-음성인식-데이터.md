...
## Basic Info
- Dataset Key: `71417`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 71417`
- Collected At: `2026-03-17T08:41:09.825140+00:00`
...
## File Overview
- File count: `52`
- Total known size: `966.1 GB`
- Representative file paths:
  - `136-1.극한 소음 음성 인식 데이터/01-1.정식개방데이터/Training/01.원천데이터/TS_01.교통수단_01.지상운송수단_1.zip`
  - `136-1.극한 소음 음성 인식 데이터/01-1.정식개방데이터/Training/01.원천데이터/TS_01.교통수단_01.지상운송수단_2.zip`
  - `136-1.극한 소음 음성 인식 데이터/01-1.정식개방데이터/Training/01.원천데이터/TS_01.교통수단_02.철로운송수단.zip`
  - `136-1.극한 소음 음성 인식 데이터/01-1.정식개방데이터/Training/01.원천데이터/TS_01.교통수단_03.항공운송수단.zip`
  - `136-1.극한 소음 음성 인식 데이터/01-1.정식개방데이터/Training/01.원천데이터/TS_01.교통수단_04.수상운송수단.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `speech/dialogue` 성격의 `audio` 자료로 보입니다. 확인 가능한 파일은 52개이며 알려진 총 용량은 966.1 GB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
...
```json
{
  ...
  "file_count": 52,
  "total_size_bytes": 1037336731648,
  "human_size": "966.1 GB",
  "sample_file_paths": [
    "136-1.극한 소음 음성 인식 데이터/01-1.정식개방데이터/Training/01.원천데이터/TS_01.교통수단_01.지상운송수단_1.zip",
    "136-1.극한 소음 음성 인식 데이터/01-1.정식개방데이터/Training/01.원천데이터/TS_01.교통수단_01.지상운송수단_2.zip",
