...
## Basic Info
- Dataset Key: `112`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 112`
- Collected At: `2026-03-17T08:40:29.030262+00:00`
...
## File Overview
- File count: `38`
- Total known size: `461.4 GB`
- Representative file paths:
  - `008.차량 내 대화 및 명령어 데이터/01.데이터/1.Training/원천데이터/2.자율주행_원천_2_명령어(차량)_training.zip`
  - `008.차량 내 대화 및 명령어 데이터/01.데이터/1.Training/원천데이터/1.AI비서_원천_1_명령어(차량)_training.zip`
  - `008.차량 내 대화 및 명령어 데이터/01.데이터/1.Training/원천데이터/1.AI비서_원천_2_명령어(차량)_training.zip`
  - `008.차량 내 대화 및 명령어 데이터/01.데이터/1.Training/원천데이터/1.AI비서_원천_3_명령어(차량)_training.zip`
  - `008.차량 내 대화 및 명령어 데이터/01.데이터/1.Training/원천데이터/1.AI비서_원천_4_명령어(차량)_training.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `speech/dialogue` 성격의 `audio` 자료로 보입니다. 확인 가능한 파일은 38개이며 알려진 총 용량은 461.4 GB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
