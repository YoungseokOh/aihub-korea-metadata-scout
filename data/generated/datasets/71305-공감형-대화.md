...
## Basic Info
- Dataset Key: `71305`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 71305`
- Collected At: `2026-03-17T08:40:59.840021+00:00`
...
## File Overview
- File count: `168`
- Total known size: `94.3 MB`
- Representative file paths:
  - `046.공감형 대화/01-1.정식개방데이터/Training/01.원천데이터/TS_기쁨_부모자녀,조손.zip`
  - `046.공감형 대화/01-1.정식개방데이터/Training/01.원천데이터/TS_기쁨_부부.zip`
  - `046.공감형 대화/01-1.정식개방데이터/Training/01.원천데이터/TS_기쁨_연인.zip`
  - `046.공감형 대화/01-1.정식개방데이터/Training/01.원천데이터/TS_기쁨_지인.zip`
  - `046.공감형 대화/01-1.정식개방데이터/Training/01.원천데이터/TS_기쁨_직장 동료.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `speech/dialogue` 성격의 `명확하지 않은 형태` 자료로 보입니다. 확인 가능한 파일은 168개이며 알려진 총 용량은 94.3 MB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
