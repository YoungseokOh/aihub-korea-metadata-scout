...
## Basic Info
- Dataset Key: `71261`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 71261`
- Collected At: `2026-03-17T08:40:56.826499+00:00`
...
## File Overview
- File count: `154`
- Total known size: `767.3 GB`
- Representative file paths:
  - `006.한-영 및 한-중 음성발화 데이터/01.데이터/1.Training/원천데이터_0830_add/TS38_2.zip`
  - `006.한-영 및 한-중 음성발화 데이터/01.데이터/1.Training/원천데이터_0830_add/TS37_1.zip`
  - `006.한-영 및 한-중 음성발화 데이터/01.데이터/1.Training/원천데이터_0830_add/TS37_2.zip`
  - `006.한-영 및 한-중 음성발화 데이터/01.데이터/1.Training/원천데이터_0830_add/TS38_1.zip`
  - `006.한-영 및 한-중 음성발화 데이터/01.데이터/1.Training/라벨링데이터_0825_add/TL10.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `speech/dialogue` 성격의 `audio` 자료로 보입니다. 확인 가능한 파일은 154개이며 알려진 총 용량은 767.3 GB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
