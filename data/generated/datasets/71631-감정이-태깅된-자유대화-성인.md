...
## Basic Info
- Dataset Key: `71631`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 71631`
- Collected At: `2026-03-17T08:41:29.546664+00:00`
...
- Representative file paths:
  - `134-1.감정이 태깅된 자유대화 (성인)/01-1.정식개방데이터/Training/01.원천데이터/TS_01.실내_1.zip`
  - `134-1.감정이 태깅된 자유대화 (성인)/01-1.정식개방데이터/Training/01.원천데이터/TS_01.실내_2.zip`
  - `134-1.감정이 태깅된 자유대화 (성인)/01-1.정식개방데이터/Training/01.원천데이터/TS_01.실내_3.zip`
  - `134-1.감정이 태깅된 자유대화 (성인)/01-1.정식개방데이터/Training/01.원천데이터/TS_01.실내_4.zip`
  - `134-1.감정이 태깅된 자유대화 (성인)/01-1.정식개방데이터/Training/01.원천데이터/TS_01.실내_5.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.
