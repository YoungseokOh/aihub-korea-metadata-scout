...
## Basic Info
- Dataset Key: `109`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 109`
- Collected At: `2026-03-17T08:40:27.711160+00:00`
...
## File Overview
- File count: `23`
- Total known size: `393.4 GB`
- Representative file paths:
  - `001.자유대화(일반남여)/01.데이터/1.Training/2.원천데이터_1022_add/1.AI챗봇/1.AI챗봇_7_자유대화(일반남여)_TRAINING.zip`
  - `001.자유대화(일반남여)/01.데이터/1.Training/2.원천데이터_1022_add/1.AI챗봇/1.AI챗봇_1_자유대화(일반남여)_TRAINING.zip`
  - `001.자유대화(일반남여)/01.데이터/1.Training/2.원천데이터_1022_add/1.AI챗봇/1.AI챗봇_2_자유대화(일반남여)_TRAINING.zip`
  - `001.자유대화(일반남여)/01.데이터/1.Training/2.원천데이터_1022_add/1.AI챗봇/1.AI챗봇_3_자유대화(일반남여)_TRAINING.zip`
  - `001.자유대화(일반남여)/01.데이터/1.Training/2.원천데이터_1022_add/1.AI챗봇/1.AI챗봇_4_자유대화(일반남여)_TRAINING.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `speech/dialogue` 성격의 `audio` 자료로 보입니다. 확인 가능한 파일은 23개이며 알려진 총 용량은 393.4 GB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
