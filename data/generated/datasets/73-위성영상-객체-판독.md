...
## Basic Info
- Dataset Key: `73`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 73`
- Collected At: `2026-03-17T08:40:23.161270+00:00`
...
## File Overview
- File count: `20`
- Total known size: `84.5 GB`
- Representative file paths:
  - `019.위성영상객체판독/1.Training/원천데이터_231107_add/train_roads_images.zip`
  - `019.위성영상객체판독/1.Training/원천데이터_231107_add/train_buildings_images.zip`
  - `019.위성영상객체판독/1.Training/원천데이터_231107_add/train_clouds_images.zip`
  - `019.위성영상객체판독/1.Training/원천데이터_231107_add/train_objects_images.zip`
  - `019.위성영상객체판독/1.Training/라벨링데이터/train_water_labeling.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `computer-vision` 성격의 `video` 자료로 보입니다. 확인 가능한 파일은 20개이며 알려진 총 용량은 84.5 GB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
