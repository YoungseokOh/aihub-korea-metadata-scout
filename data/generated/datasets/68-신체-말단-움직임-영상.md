...
## Basic Info
- Dataset Key: `68`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 68`
- Collected At: `2026-03-17T08:40:22.561148+00:00`
...
## File Overview
- File count: `134`
- Total known size: `645.0 GB`
- Representative file paths:
  - `094.신체 말단 움직임 영상 데이터/01.데이터/1.Training/02. 원천데이터_0828_ADD/입술/94_입술_수사_TR.zip`
  - `094.신체 말단 움직임 영상 데이터/01.데이터/1.Training/02. 원천데이터_0828_ADD/입술/94_입술_형용사_TR.zip`
  - `094.신체 말단 움직임 영상 데이터/01.데이터/1.Training/02. 원천데이터_0828_ADD/입술/94_입술_감탄사_TR.zip`
  - `094.신체 말단 움직임 영상 데이터/01.데이터/1.Training/02. 원천데이터_0828_ADD/입술/94_입술_고유명사_TR.zip`
  - `094.신체 말단 움직임 영상 데이터/01.데이터/1.Training/02. 원천데이터_0828_ADD/입술/94_입술_관형사_TR.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `computer-vision` 성격의 `video` 자료로 보입니다. 확인 가능한 파일은 134개이며 알려진 총 용량은 645.0 GB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
