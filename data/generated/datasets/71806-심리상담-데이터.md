...
## Basic Info
- Dataset Key: `71806`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 71806`
- Collected At: `2026-03-17T08:41:41.312404+00:00`
...
## File Overview
- File count: `150`
- Total known size: `73.7 MB`
- Representative file paths:
  - `16.심리상담 데이터/3.개방데이터/1.데이터/Training/02.라벨링데이터/TL_004. 일반군_0009. 9회기.zip`
  - `16.심리상담 데이터/3.개방데이터/1.데이터/Training/02.라벨링데이터/TL_001. 우울증_0001. 1회기.zip`
  - `16.심리상담 데이터/3.개방데이터/1.데이터/Training/02.라벨링데이터/TL_001. 우울증_0002. 2회기.zip`
  - `16.심리상담 데이터/3.개방데이터/1.데이터/Training/02.라벨링데이터/TL_001. 우울증_0003. 3회기.zip`
  - `16.심리상담 데이터/3.개방데이터/1.데이터/Training/02.라벨링데이터/TL_001. 우울증_0004. 4회기.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `speech/dialogue` 성격의 `명확하지 않은 형태` 자료로 보입니다. 확인 가능한 파일은 150개이며 알려진 총 용량은 73.7 MB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
