...
## Basic Info
- Dataset Key: `650`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 650`
- Collected At: `2026-03-17T08:40:56.142028+00:00`
...
- Representative file paths:
  - `089.차량 내 탑승자 상황 인식 영상 데이터/01.데이터/1.Training/라벨링데이터_230705_add/TL1.tar`
  - `089.차량 내 탑승자 상황 인식 영상 데이터/01.데이터/1.Training/라벨링데이터_230705_add/TL10.tar`
  - `089.차량 내 탑승자 상황 인식 영상 데이터/01.데이터/1.Training/라벨링데이터_230705_add/TL11.tar`
  - `089.차량 내 탑승자 상황 인식 영상 데이터/01.데이터/1.Training/라벨링데이터_230705_add/TL12.tar`
  - `089.차량 내 탑승자 상황 인식 영상 데이터/01.데이터/1.Training/라벨링데이터_230705_add/TL13.tar`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `computer-vision` 성격의 `multimodal` 자료로 보입니다. 확인 가능한 파일은 36개이며 알려진 총 용량은 1.42 TB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
...
{
  "dataset_key": 650,
  "title": "차량 내 인터페이스 개선을 위한 멀티모달 데이터",
  "tags": [
    "computer-vision",
    "multimodal",
    "video",
  ...
  "file_count": 36,
  "total_size_bytes": 1565380313088,
  "human_size": "1.42 TB",
  "sample_file_paths": [
    "089.차량 내 탑승자 상황 인식 영상 데이터/01.데이터/1.Training/라벨링데이터_230705_add/TL1.tar",
    "089.차량 내 탑승자 상황 인식 영상 데이터/01.데이터/1.Training/라벨링데이터_230705_add/TL10.tar",
