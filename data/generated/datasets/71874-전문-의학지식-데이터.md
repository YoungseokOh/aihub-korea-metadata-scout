...
## Basic Info
- Dataset Key: `71874`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 71874`
- Collected At: `2026-03-17T08:41:45.544895+00:00`
...
## File Overview
- File count: `37`
- Total known size: `196.1 MB`
- Representative file paths:
  - `08.전문 의학지식 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_국문_기타.zip`
  - `08.전문 의학지식 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_국문_온라인 의료 정보 제공 사이트.zip`
  - `08.전문 의학지식 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_국문_의학 교과서.zip`
  - `08.전문 의학지식 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_국문_학술 논문 및 저널.zip`
  - `08.전문 의학지식 데이터/3.개방데이터/1.데이터/Training/01.원천데이터/TS_국문_학회 가이드라인.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `education` 성격의 `text` 자료로 보입니다. 확인 가능한 파일은 37개이며 알려진 총 용량은 196.1 MB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
