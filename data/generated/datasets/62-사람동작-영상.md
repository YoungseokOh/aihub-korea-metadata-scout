...
## Basic Info
- Dataset Key: `62`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 62`
- Collected At: `2026-03-17T08:40:21.800598+00:00`
...
## File Overview
- File count: `100`
- Total known size: `2.45 TB`
- Representative file paths:
  - `16.사람동작영상/video/video_action_14.tar`
  - `16.사람동작영상/video/video_action_15.tar`
  - `16.사람동작영상/video/video_action_16.tar`
  - `16.사람동작영상/video/video_action_17.tar`
  - `16.사람동작영상/video/video_action_18.tar`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `computer-vision` 성격의 `3d/lidar` 자료로 보입니다. 확인 가능한 파일은 100개이며 알려진 총 용량은 2.45 TB입니다. 압축 파일 조각이 많아 보여 파일 정리와 전처리 부담이 커질 수 있습니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
...
```json
{
  ...
  "file_count": 100,
  "total_size_bytes": 2692431740928,
  "human_size": "2.45 TB",
  "sample_file_paths": [
    "16.사람동작영상/video/video_action_14.tar",
    "16.사람동작영상/video/video_action_15.tar",
