...
## Basic Info
- Dataset Key: `93`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 93`
- Collected At: `2026-03-17T08:40:26.212211+00:00`
...
## File Overview
- File count: `2`
- Total known size: `202.0 MB`
- Representative file paths:
  - `019.도서자료 요약 데이터/01.데이터/2.Validation/[원천]도서요약_valid.zip`
  - `019.도서자료 요약 데이터/01.데이터/1.Training/[원천]도서요약_train.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `nlp/knowledge` 성격의 `text` 자료로 보입니다. 확인 가능한 파일은 2개이며 알려진 총 용량은 202.0 MB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
