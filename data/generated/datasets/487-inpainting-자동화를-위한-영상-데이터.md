...
## Basic Info
- Dataset Key: `487`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 487`
- Collected At: `2026-03-17T08:40:42.796176+00:00`
...
## File Overview
- File count: `168`
- Total known size: `538.1 GB`
- Representative file paths:
  - `040.Inpainting 자동화를 위한 영상 데이터/01.데이터/1.Training/라벨링데이터/png/TL12_실외_사물.zip`
  - `040.Inpainting 자동화를 위한 영상 데이터/01.데이터/1.Training/라벨링데이터/png/TL13_실내_운동.zip`
  - `040.Inpainting 자동화를 위한 영상 데이터/01.데이터/1.Training/라벨링데이터/png/TL14_실내_업무.zip`
  - `040.Inpainting 자동화를 위한 영상 데이터/01.데이터/1.Training/라벨링데이터/png/TL15_실내_여행.zip`
  - `040.Inpainting 자동화를 위한 영상 데이터/01.데이터/1.Training/라벨링데이터/png/TL16_실내_여가.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `computer-vision` 성격의 `video` 자료로 보입니다. 확인 가능한 파일은 168개이며 알려진 총 용량은 538.1 GB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
...
{
  "dataset_key": 487,
  "title": "Inpainting 자동화를 위한 영상 데이터",
  "tags": [
    "computer-vision",
    "video",
    "영상",
