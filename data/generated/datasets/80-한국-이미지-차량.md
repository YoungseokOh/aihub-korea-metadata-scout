...
## Basic Info
- Dataset Key: `80`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 80`
- Collected At: `2026-03-17T08:40:25.019503+00:00`
...
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `computer-vision` 성격의 `image` 자료로 보입니다. 확인 가능한 파일은 1개이며 알려진 총 용량은 63.0 GB입니다. 파일 트리 정보가 제한적이어서 구조 판단은 보수적으로 해석해야 합니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
