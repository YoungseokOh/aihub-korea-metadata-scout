...
## Basic Info
- Dataset Key: `505`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 505`
- Collected At: `2026-03-17T08:40:44.266945+00:00`
...
## File Overview
- File count: `24`
- Total known size: `342.7 GB`
- Representative file paths:
  - `131.인공지능 학습을 위한 외국인 한국어 발화 음성 데이터/01.데이터_new_20220719/1.Training/라벨링데이터/1. 베트남어.zip`
  - `131.인공지능 학습을 위한 외국인 한국어 발화 음성 데이터/01.데이터_new_20220719/1.Training/라벨링데이터/2. 영어.zip`
  - `131.인공지능 학습을 위한 외국인 한국어 발화 음성 데이터/01.데이터_new_20220719/1.Training/라벨링데이터/3. 일본어.zip`
  - `131.인공지능 학습을 위한 외국인 한국어 발화 음성 데이터/01.데이터_new_20220719/1.Training/라벨링데이터/4. 중국어.zip`
  - `131.인공지능 학습을 위한 외국인 한국어 발화 음성 데이터/01.데이터_new_20220719/1.Training/라벨링데이터/5. 태국어.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `speech/dialogue` 성격의 `audio` 자료로 보입니다. 확인 가능한 파일은 24개이며 알려진 총 용량은 342.7 GB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
...
{
  "dataset_key": 505,
  "title": "인공지능 학습을 위한 외국인 한국어 발화 음성 데이터",
  "tags": [
    "speech/dialogue",
    "audio",
    "발화",
