...
## Basic Info
- Dataset Key: `71290`
- Source Command: `/root/.local/bin/aihubshell -mode l -datasetkey 71290`
- Collected At: `2026-03-17T08:40:57.938222+00:00`
...
## File Overview
- File count: `56`
- Total known size: `24.3 GB`
- Representative file paths:
  - `300.해외상표 이미지 AI 데이터/01-1.정식개방데이터/Validation/02.라벨링데이터/VL_1884-2009.zip`
  - `300.해외상표 이미지 AI 데이터/01-1.정식개방데이터/Validation/02.라벨링데이터/VL_2013.zip`
  - `300.해외상표 이미지 AI 데이터/01-1.정식개방데이터/Validation/02.라벨링데이터/VL_2014.zip`
  - `300.해외상표 이미지 AI 데이터/01-1.정식개방데이터/Validation/02.라벨링데이터/VL_2015.zip`
  - `300.해외상표 이미지 AI 데이터/01-1.정식개방데이터/Validation/02.라벨링데이터/VL_2016.zip`
- Notices / warnings:
  - 공지사항은 보이지 않았습니다.

## What This Dataset Appears To Be
제목과 파일 트리를 기준으로 보면 이 데이터셋은 `computer-vision` 성격의 `image` 자료로 보입니다. 확인 가능한 파일은 56개이며 알려진 총 용량은 24.3 GB입니다. training/validation 분리가 보여서 기본 실험 파이프라인을 구성하기는 쉬워 보입니다. 세부 의미 해석은 하지 않았고, 이 설명은 제목과 파일 트리만으로 추론했습니다 (inferred from title and file tree only).
